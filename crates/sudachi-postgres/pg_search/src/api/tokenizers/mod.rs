...
#[cfg(feature = "sudachi")]
pub use crate::api::tokenizers::typmod::SudachiTypmod;
...
pub fn search_field_config_from_type(
    ...
    let mut tokenizer = match type_name.as_str() {
        ...
        "sudachi" => SearchTokenizer::Sudachi {
            mode: tokenizers::sudachi::SudachiMode::Search,
            normalized: true,
            filters: SearchTokenizerFilters::default(),
        },
        _ => return None,
...
pub fn apply_typmod(tokenizer: &mut SearchTokenizer, typmod: Typmod) {
    match tokenizer {
        ...
        SearchTokenizer::Sudachi {
            ...
            let sudachi_typmod = SudachiTypmod::try_from(typmod).unwrap_or_else(|e| {
                panic!("{}", e);
            });
            *mode = sudachi_typmod.mode;
            *normalized = sudachi_typmod.normalized;
            *filters = sudachi_typmod.filters;
        }
    }
}
