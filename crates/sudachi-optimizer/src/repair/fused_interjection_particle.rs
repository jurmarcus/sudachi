//! `RepairFusedInterjectionParticle` — Repair interjection + particle fused into single token.
//!
...
//!
//! Method: `RepairFusedInterjectionParticle` (search the C# source for the function definition).
...
/// the [`StageGroup::Repair`] grouping, and the [`TokenFeatures`]
/// gate.
pub fn stage() -> Stage {
    Stage::new(NAME, StageGroup::Repair, TokenFeatures::INTERJECTION, apply)
}
