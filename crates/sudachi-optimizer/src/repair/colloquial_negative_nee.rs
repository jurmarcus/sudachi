//! `RepairColloquialNegativeNee` — Repair colloquial negative ねえ (= ない) classified as interjection.
//!
...
//!
//! Method: `RepairColloquialNegativeNee` (search the C# source for the function definition).
