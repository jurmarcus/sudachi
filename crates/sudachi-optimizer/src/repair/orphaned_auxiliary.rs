//! `RepairOrphanedAuxiliary` — Repair auxiliary morphemes left orphaned after preceding stages.
//!
...
//! in a follow-up commit. Search the C# source for `RepairOrphanedAuxiliary` to find
