//! `RepairOrphanedAuxiliary` — Repair auxiliary tokens left orphaned after preceding stages.
//!
...
//!
//! Method: `RepairOrphanedAuxiliary` (search the C# source for the function definition).
...
/// gate.
pub fn stage() -> Stage {
    Stage::new(NAME, StageGroup::Repair, TokenFeatures::empty(), apply)
}
