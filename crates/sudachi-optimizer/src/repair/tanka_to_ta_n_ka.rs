//! `RepairTankaToTaNKa` — Repair たんか misparsed as 短歌 noun when it should be た + ん + か.
//!
...
//!
//! Method: `RepairTankaToTaNKa` (search the C# source for the function definition).
...
/// gate.
pub fn stage() -> Stage {
    Stage::new(NAME, StageGroup::Repair, TokenFeatures::TEXT_TANKA, apply)
}
