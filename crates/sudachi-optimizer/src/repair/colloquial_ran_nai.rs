//! `RepairColloquialRanNai` — Repair colloquial らん (= ない) form.
//!
...
//!
//! Method: `RepairColloquialRanNai` (search the C# source for the function definition).
...
/// gate.
pub fn stage() -> Stage {
    Stage::new(NAME, StageGroup::Repair, TokenFeatures::TEXT_RAN, apply)
}
