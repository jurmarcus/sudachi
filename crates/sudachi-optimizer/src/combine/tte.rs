//! `CombineTte` — Combine 〜って sequences split by Sudachi (走った → 走っ + た).
//!
...
//!
//! Method: `CombineTte` (search the C# source for the function definition).
...
/// gate.
pub fn stage() -> Stage {
    Stage::new(NAME, StageGroup::Combine, TokenFeatures::ENDS_WITH_TSU, apply)
}
