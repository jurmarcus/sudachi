//! `CombineConjunctiveParticle` — Combine conjunctive particles (て, ば, ても, …) with verb stems.
//!
...
//!
//! Method: `CombineConjunctiveParticle` (search the C# source for the function definition).
...
/// gate.
pub fn stage() -> Stage {
    Stage::new(NAME, StageGroup::Combine, TokenFeatures::CONJ_PARTICLE, apply)
}
