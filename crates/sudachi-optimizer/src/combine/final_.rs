//! `CombineFinal` — Final combine pass: merge sentence-end particles (よね, わよ, …).
//!
...
//!
//! Method: `CombineFinal` (search the C# source for the function definition).
...
pub const NAME: &str = "combine_final_";
