//! `CombineAdverbialParticle` — Combine adverbial particles (も, さえ, …) with their host.
//!
...
//!
//! Method: `CombineAdverbialParticle` (search the C# source for the function definition).
...
/// gate.
pub fn stage() -> Stage {
    Stage::new(NAME, StageGroup::Combine, TokenFeatures::ADV_PARTICLE, apply)
}
