//! `CombineAmounts` — Combine numeric tokens with their counter (3 + 人 → 3人).
//!
...
//!
//! Method: `CombineAmounts` (search the C# source for the function definition).
...
/// gate.
pub fn stage() -> Stage {
    Stage::new(NAME, StageGroup::Combine, TokenFeatures::NUMERIC_AMOUNT, apply)
}
