//! `CombineVerbDependant` — Combine dependent verbs (来る, いる, …) with the preceding 〜て form.
//!
...
//!
//! Method: `CombineVerbDependant` (search the C# source for the function definition).
