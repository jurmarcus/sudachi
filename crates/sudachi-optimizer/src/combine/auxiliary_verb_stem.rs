//! `CombineAuxiliaryVerbStem` — Combine auxiliary verb stems with their preceding form.
//!
...
//!
//! Method: `CombineAuxiliaryVerbStem` (search the C# source for the function definition).
...
/// gate.
pub fn stage() -> Stage {
    Stage::new(NAME, StageGroup::Combine, TokenFeatures::AUX_VERB_STEM, apply)
}
