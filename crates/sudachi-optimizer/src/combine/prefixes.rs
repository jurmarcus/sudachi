//! `CombinePrefixes` — Merge prefix tokens with the noun that follows.
//!
...
//!
//! Method: `CombinePrefixes` (search the C# source for the function definition).
...
/// gate.
pub fn stage() -> Stage {
    Stage::new(NAME, StageGroup::Combine, TokenFeatures::PREFIX, apply)
}
