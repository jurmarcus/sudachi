//! `SplitTanSuffix` — Split たん(suffix) + だ/です into [prev+た] + ん + だ/です for explanatory のだ.
//!
...
//!
//! Method: `SplitTanSuffix` (search the C# source for the function definition).
...
/// gate.
pub fn stage() -> Stage {
    Stage::new(NAME, StageGroup::Split, TokenFeatures::TEXT_TAN_SUFFIX, apply)
}
