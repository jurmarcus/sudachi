//! `SplitCompoundAuxiliaryVerbs` — Split compound verbs Sudachi outputs as one morpheme (e.g., し終わっ → し + 終わっ).
//!
...
//! in a follow-up commit. Search the C# source for `SplitCompoundAuxiliaryVerbs` to find
