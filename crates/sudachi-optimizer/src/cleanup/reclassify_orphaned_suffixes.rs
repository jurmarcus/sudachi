//! `ReclassifyOrphanedSuffixes` — Reclassify suffix tokens that didn't merge with a host as standalone nouns.
//!
...
//!
//! Method: `ReclassifyOrphanedSuffixes` (search the C# source for the function definition).
...
/// gate.
pub fn stage() -> Stage {
    Stage::new(NAME, StageGroup::Cleanup, TokenFeatures::SUFFIX, apply)
}
